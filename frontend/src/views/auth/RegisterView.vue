        ...
        <div class="auth-brand">
          <div class="auth-brand-mark">
            <svg viewBox="0 0 32 32" width="38" height="38" fill="none">
              <rect x="1" y="1" width="30" height="30" rx="12" fill="#F472B6" stroke="#1E293B" stroke-width="2" />
...
.text-strength-good    { color: var(--color-info); }
...
.alert-success {
  ...
  color: #047857;
  box-shadow: 4px 4px 0 0 rgba(16, 185, 129, 0.22);
}
